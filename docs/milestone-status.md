...
| Finite single-row shapes | [CPU experiment](shape-profile-experiment.md) preserves decoded answers across six fixtures; 17 row executions use widths 32, 64, 128 and 512 with 64 marker slots | Width 256 full-model coverage, exact-profile compilation, precision acceptance and physical parity |
