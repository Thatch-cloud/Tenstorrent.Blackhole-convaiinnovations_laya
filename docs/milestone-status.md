...
| Finite single-row shapes | [CPU experiment and offline compilation](shape-profile-experiment.md) cover widths 32, 64, 128, 256 and 512 with 64 marker slots; six fixtures retain identical CPU decoded answers; all five compiled profiles have verified artifacts and input hashes | Content-length and marker-limit quality coverage, lowered precision acceptance, device memory fit and physical parity |
